...
async function seed() {
  ...
  try {
    ...
    await insertSteps(client, f1.id, [
      {
        ...
        cfg: {
          ...
          url: "/rate_limit",
          headers: {
            "User-Agent": "Syntrix-Synthetic/1.0",
    ...
    await insertSteps(client, f2.id, [
      ...
      },
      {
        ...
        cfg: {
          ...
          body: {
            amount: 4999,
            token: "tok_visa_synthetic",
            description: "Syntrix test charge",
          },
          assertStatus: 200,
          assertFn:
            'data.json.amount === 4999 && typeof data.json.description === "string"',
        },
      },
      {
    ...
    await insertSteps(client, f4.id, [
      ...
      },
      {
        ...
        cfg: {
          ...
          assertStatus: 200,
          assertFn:
            'data.json.sku === "WIDGET-001" && data.json.quantity === 2',
        },
      },
      {
      ...
      },
      {
        ...
        cfg: {
          ...
          assertStatus: 200,
          assertFn:
            'data.json.status === "confirmed" && data.json.order_total === 47.98',
        },
      },
      {
        ...
        cfg: {
          method: "GET",
          url: "/get?action=email_sent&template=order_confirm",
          assertStatus: 200,
    ...
    console.log(
      "These flows use GitHub API + HTTPBin — both always available,",
    );
